...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/haec/security/advisories/new)
...
- This repository (`hyperpolymath/haec`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/haec/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/haec/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/haec/discussions) |
...
*Thank you for helping keep Haec and its users safe.* 🛡️
