...
#
# Haec — Cerro Torre build, sign, and verify pipeline
#
...
#   CT_KEY_ID       — Signing key identifier (default: haec-release)
...
CT_KEY_ID="${CT_KEY_ID:-haec-release}"
...
echo "=== Haec Cerro Torre Build Pipeline ==="
